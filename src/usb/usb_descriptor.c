...
typedef enum
{
  ...
  USB_INTERFACE_IDX_CDD_IRQ,
  USB_INTERFACE_IDX_CDD_DATA,
  /* Interfaces count */
...
typedef enum
{
  ...
  USB_ENDPOINT_IDX_CDD_IRQ,
  USB_ENDPOINT_IDX_CDD_DATA,
  /* Endpoints count */
...
/* Interface 2, Alternate Setting 0, CDC Class */
  USB_INTERFACE_DESCRIPTOR_SIZE,         /* bLength */
  USB_INTERFACE_DESCRIPTOR_TYPE,         /* bDescriptorType */
  USB_INTERFACE_IDX_CDD_IRQ,             /* bInterfaceNumber */
  0x00,                                  /* bAlternateSetting */
  0x01,                                  /* bNumEndpoints */
  USB_DEVICE_CLASS_COMMUNICATIONS,       /* bInterfaceClass */
  CDC_IF_SUBCLASS_ACM,                   /* bInterfaceSubClass */
...
/* Endpoint Interrupt Descriptor */
  USB_ENDPOINT_DESCRIPTOR_SIZE,          /* bLength */
  USB_ENDPOINT_DESCRIPTOR_TYPE,          /* bDescriptorType */
  USB_ENDPOINT_I(USB_ENDPOINT_IDX_CDD_IRQ), /* bEndpointAddress */
  USB_ENDPOINT_TYPE_INTERRUPT,           /* bmAttributes */
  WBVAL(USB_CDC_IRQ_PACKET_SIZE),        /* wMaxPacketSize */
  USB_CDC_IRQ_INTERVAL,                  /* bInterval */
/* Interface 3, Data Class Interface Descriptor */
  USB_INTERFACE_DESCRIPTOR_SIZE,         /* bLength */
  USB_INTERFACE_DESCRIPTOR_TYPE,         /* bDescriptorType */
  USB_INTERFACE_IDX_CDD_DATA,            /* bInterfaceNumber */
  0x00,                                  /* bAlternateSetting */
  0x02,                                  /* bNumEndpoints */
  CDC_IF_CLASS_CDC,                      /* bInterfaceClass */
  CDC_IF_SUBCLASS_NONE,                  /* bInterfaceSubClass */
...
/* Bulk Out Endpoint */
  USB_ENDPOINT_DESCRIPTOR_SIZE,          /* bLength */
  USB_ENDPOINT_DESCRIPTOR_TYPE,          /* bDescriptorType */
  USB_ENDPOINT_O(USB_ENDPOINT_IDX_CDD_DATA), /* bEndpointAddress */
  USB_ENDPOINT_TYPE_BULK,                /* bmAttributes */
  WBVAL(USB_CDC_PACKET_SIZE),            /* wMaxPacketSize */
  0,                                     /* bInterval */
/* Bulk In Endpoint */
  USB_ENDPOINT_DESCRIPTOR_SIZE,          /* bLength */
  USB_ENDPOINT_DESCRIPTOR_TYPE,          /* bDescriptorType */
  USB_ENDPOINT_I(USB_ENDPOINT_IDX_CDD_DATA), /* bEndpointAddress */
  USB_ENDPOINT_TYPE_BULK,                /* bmAttributes */
  WBVAL(USB_CDC_PACKET_SIZE),            /* wMaxPacketSize */
  0,                                     /* bInterval */
      ...
      USBD_IfCbDescriptor[USB_INTERFACE_IDX_CNT] =
{
  ...
  [USB_INTERFACE_IDX_CDD_IRQ] =
  {
    ...
    .CbCtrlOut   = CDC_CtrlOutReq,
    .CbSOF       = NULL,
    .CbEndPointI = CDC_InterruptBIn,
    .CbEndPointO = NULL,
    .EndPointI   = USB_ENDPOINT_I(USB_ENDPOINT_IDX_CDD_IRQ),
    .EndPointO   = 0,
  },
  [USB_INTERFACE_IDX_CDD_DATA] =
  {
    ...
    .EndPointI   = USB_ENDPOINT_I(USB_ENDPOINT_IDX_CDD_DATA),
    .EndPointO   = USB_ENDPOINT_O(USB_ENDPOINT_IDX_CDD_DATA),
  },
};
...
{
  return USB_INTERFACE_IDX_CDD_IRQ;
}
